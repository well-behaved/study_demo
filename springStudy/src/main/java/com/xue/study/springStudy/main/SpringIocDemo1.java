...
public class SpringIocDemo1 {
    public static void main(String[] args) {
        ...
        而这个信息来源需要封装成Spring中的Resource类来给出。Resource是Spring用来封装1/0操作的类。比如，我们的BeanDefinition信息是以XML文件形式存在的，那么可以使用像”ClassPath-Resourceres=newClassPathResource(“beans.xml”);”这样具体的ClassPathResource来构造需要的Resource,然后将Resource作为构造参数传递给XmlBeanFactory构造函数
